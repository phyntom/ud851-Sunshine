...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewWeatherData = (TextView) findViewById(R.id.tv_weather_data);

        // COMPLETED (3) Create an array of Strings that contain fake weather data
        String[] weatherData = {"26 C Kigali", "27 C Huye", " 25 C Rubavu"};

        // TODO (4) Append each String from the fake weather data array to the TextView
        for (String strData : weatherData) {
            textViewWeatherData.append(strData + "\n\n");
        }
    }
}